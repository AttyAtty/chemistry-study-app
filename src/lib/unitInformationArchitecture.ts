...
export type UnitPageArchitecture = {
  ...
  detailLabel?: string;
  flashcardAfterSectionId?: string;
};
...
const architectures:Record<string,UnitPageArchitecture>={
  ...
  "colors-and-tests":{featuredSectionIds:["solution-colors","precipitate-colors","complex-ion-reactions"],quickLinks:[{label:"イオンの色",sectionId:"solution-colors"},{label:"沈殿の色",sectionId:"precipitate-colors"}],featuredLabel:"色・沈殿の早見",detailLabel:"確認反応・系統分離・炎色反応",flashcardAfterSectionId:"precipitate-colors"},
  "laboratory-gases":{featuredSectionIds:["gas-overview","gas-collection","gas-preparation-table","gas-detection"],quickLinks:[{label:"気体比較",sectionId:"gas-overview"},{label:"捕集方法",sectionId:"gas-collection"},{label:"製法",sectionId:"gas-preparation-table"}],featuredLabel:"比較・捕集・製法",detailLabel:"演習・反応・安全情報",flashcardAfterSectionId:"gas-collection"},
